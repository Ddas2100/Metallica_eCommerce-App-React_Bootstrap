...
import { productsArr } from '../Layout/Constants';
                    ...
                    <Col sm={6} xl={4} className='d-flex flex-column gap-2 p-0'>
                        <div className='d-flex gap-2'>
                            <div className='d-flex flex-column gap-1 p-1'>
                                {product.moreImgs.map((url, index) => (
                                    <Image
                                        ...
                                        height={55}
                                        src={url}
                                        className={`border ${activeIdx === index ? 
                                            'border-2 border-primary rounded-1' : 'border-1'
                                        }`}
                            ...
                            <div className='w-100 overflow-hidden'>
                                <Image className='w-100 border border-1 rounded-2 border-secondary' src={thumbnail} />
                            </div>
                        </div>
                        ...
                        <div className='d-flex gap-2 w-100'>
                            ...
                            <Button className='w-100 fw-semibold rounded-0 py-2'
