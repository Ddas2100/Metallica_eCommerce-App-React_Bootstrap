...
function OffCanvasCart ({name, btn, btnSpan, ...props}) {
    ...
    return (
        <>
            ...
            <Offcanvas show={showCart} onHide={handleClose} {...props}>
                        ...
                        <Container className='d-flex flex-column'>
                            ...
                            {cartCtx.items.map((item) => (
                                <Row key={item._id} className='gap-2'>
                                    ...
                                    <Col className='justify-content-center align-items-center d-flex border-black border-bottom py-2'
                                    xs={2} >
                                        <p className='mb-0'>${item.price}</p>
                                    </Col>
                                    <Col className='justify-content-between align-items-center d-flex gap-2 border-black border-bottom py-2'
                                    xs={3}>
